...
urlpatterns = [
    ...
    re_path(r'^product/category/(?P<category>\w+)$', views.ProductCategoryView.as_view(), name='product-category-lisy'),
    re_path(r'^product/reviews/$', views.ProductsReviewsListView.as_view(), name='products-reviews-list'),
    re_path(r'^product/(?P<product_id>\d+)/reviews/$', views.ProductsReviewsListView.as_view(),
            name='product-review-list'),
    re_path(r'^product/(?P<product_id>\d+)/reviews/(?P<review_id>\d+)$', views.ReviewView.as_view(),
            name='product-review'),
]