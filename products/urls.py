...
urlpatterns = [
    ...
    re_path(r'^product/category/(?P<category>\d+)$', views.ProductCategoryView.as_view(), name='product-category-lisy'),
    ...
    re_path(r'^product/(?P<product_id>\d+)/reviews(?P<review_id>\d+)$', views.ReviewView.as_view(), name='product-review'),
